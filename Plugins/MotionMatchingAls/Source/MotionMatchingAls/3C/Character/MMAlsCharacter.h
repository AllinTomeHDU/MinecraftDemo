...
protected:
	...
	*/
	UFUNCTION(Server, Reliable)
	void Server_SetHitReacting(const bool bHitReacting);

	UFUNCTION()
	void OnRep_HitReacting(bool bPrevHitReactiong);

	virtual void OnHitReactingChanged(bool bPrevHitReactiong);
...
private:
	...
	UPROPERTY(ReplicatedUsing = "OnRep_HitReacting", VisibleAnywhere, BlueprintReadOnly, Category = "MMAls|HitReacting", meta = (AllowPrivateAccess = "true"))
	bool bIsHitReacting;
