#include "FileHelper/FileHelperBPLibrary.h"
using namespace BlueprintFileHelper;


FFileHelper::EHashOptions BlueprintFileHelper::ToHashOptions(EHashOptionsBP HashOptions)
{
	switch (HashOptions)
	{
...
{
	return FFileHelper::LoadFileToString(Result, *Filename, ToHashOptions(VerifyFlags));
}
