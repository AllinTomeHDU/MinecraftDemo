...
FIntVector UMCVoxelUtilsLibrary::WorldToBlockPosition(const FVector& WorldPosition)
{
	return FIntVector(WorldPosition / 100.f);
}

FIntVector UMCVoxelUtilsLibrary::WorldToLocalBlockPosition(const FVector& Position, const FIntVector& ChunkSize)
{
...
FIntVector UMCVoxelUtilsLibrary::WorldToChunkPosition(const FVector& Position, const FIntVector& ChunkSize)
{
	FIntVector Result;
